...
class NumbersViewModelTest {
    ...
    fun testGetNumbersWithSuccess() {
        runBlocking {
            ...
            whenever(numbersRepository.getNumbersAsync()).thenReturn(data)
            //endregion

            //region When
            numbersViewModel.getNumbers().observeForever(numbersResourceObserver)
            delay(10)
            //endregion
    ...
    fun testGetNumbersWithFailure() {
        runBlocking {
            ...
            whenever(numbersRepository.getNumbersAsync()).thenReturn(error)
            //endregion
